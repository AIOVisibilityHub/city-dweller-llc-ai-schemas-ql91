...
BIZ = _client.get('name') or manifest.get('businessName', 'City Dweller, LLC')
WEBSITE = _client.get('canonicalUrl') or manifest.get('canonicalUrl', '') or manifest.get('websiteUrl', 'http://bayareacitydweller.com/')
